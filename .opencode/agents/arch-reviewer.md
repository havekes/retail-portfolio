...
Procedure:
1. Read `PROJECT.md` (the trajectory), open ticket issues (`gh issue list --label ticket`), previous reports in `.opencode/reviews/`, and any open `ARCH` issues (never re-ticket an open finding).
