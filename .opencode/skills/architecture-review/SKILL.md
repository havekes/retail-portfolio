...
description: Use when performing an on-demand architecture health check of the codebase — evaluating structure, boundaries, data model, and tech choices against PROJECT.md goals, writing a report to .opencode/reviews/, and emitting actionable architectural improvement tickets as GitHub issues (id prefix ARCH-T) via the gh CLI.
---
