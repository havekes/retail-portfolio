...
def upgrade() -> None:
    ...
    op.create_index('ix_account_user_institution_type', 'account', ['user_id', 'institution_id', 'account_type_id'], unique=False)
    op.create_table('action_item',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('ticker_symbol', sa.String(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('action', sa.Enum('hold', 'observe', 'buy', 'sell', name='actionenum'), nullable=False),
